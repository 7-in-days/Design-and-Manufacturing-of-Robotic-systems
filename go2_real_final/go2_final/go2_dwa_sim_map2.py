...
class OccupancyDWAPlanner:
    def __init__(self):
        ...
        # self.cruise_speed = 0.5 # 장애물이 멀거나 없을 때 기본 전진 속도 linear.x # 되는거
    ...
    def compute_command(self, grid, resolution, center_x, center_y):
        """occupancy grid를 받아 최종 linear.x, angular.z 명령을 계산."""
    ...
    def get_front_obstacle_cells(self, grid, center_x, center_y):
        ...
        """grid에서 전방 ROI 안에 있는 장애물 cell의 row/col만 추출."""
    ...
    def simulate_trajectory(self, v, wz):
        ...
        """주어진 linear.x와 angular.z로 미래 경로를 가상 시뮬레이션."""
    ...
    def choose_fallback_turn_direction(self, occ_rows, center_y):
        ...
        """모든 후보가 reject됐을 때 장애물이 적은 쪽으로 제자리 회전 방향을 정함."""
